const supermarket = [
  { id: 1, name: "Rice (5kg)", price: 120.00, image: "/img/rice.jpg" },
  { id: 2, name: "Bread", price: 15.00, image: "/img/b.jpg" },
  { id: 3, name: "Milk", price: 12.00, image: "/img/m.jpg" },
  { id: 4, name: "Eggs (crate)", price: 55.00, image: "/img/g.jpg" },
  { id: 5, name: "Sugar (1kg)", price: 18.00, image: "/img/s.jpg" },
  { id: 6, name: "Cooking Oil (1L)", price: 35.00, image: "/img/c.jpg" },
  { id: 7, name: "Tomatoes", price: 10.00, image: "/img/t.jpg" },
  { id: 8, name: "Onions", price: 8.00, image: "/img/on.jpg" },
  { id: 9, name: "Canned Fish", price: 20.00, image: "/img/c.jpg" },
  { id: 10, name: "Biscuits", price: 7.00, image: "/img/bis.jpg" }
];
...
document.addEventListener("click", function (e) {
  ...
  const id = Number(subItem.dataset.id);
  ...
  if (decBtn && cartItem.quantity > 1) {
    cartItem.quantity -= 1;
  }

  subItem.querySelector(".quantity").textContent = cartItem.quantity;
...
function cartTt() {
  ...
  num.textContent = `Number of Items : ${totalQty}`;
